...
{ 
    ...
    if (plotField) 
    {
        ...
        fieldView->SetArea(-pitch*5 , -0.1, pitch*5 , 0.1);
    ...
    summaray_electron.open ("summaray_electron.txt");
    time_electron.open ("time_electron.txt");
    position_ion.open ("position_ion.txt");
    position_electron.open ("position_electron.txt");
    ...
    if (plotDrift) 
    {
        ...
        if (plotMesh) 
        {
            ...
            meshView->SetArea(-5 * pitch, -5 * pitch, -0.1, 
                               5 * pitch,  5 * pitch, 0.1);
        ...
        } else 
        {
            ...
            driftView->SetCollisionMarkerSize(.5);
            driftView->Plot();
        }
    }
